...
```{r fig.all, eval=TRUE, echo=FALSE, fig.width=4.8, fig.height=1.3, fig.cap="\\textbf{Summary of biological ontologies.} All panels show stratification of a collection of ontologies by \\textbf{(A)} the number of terms (classes), \\textbf{(B)} the time since last update, and \\textbf{(C)} the number of their disconnected components. Bar colors convey the criteria used to select ontologies for subsequent analysis."}
